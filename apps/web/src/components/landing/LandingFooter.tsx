      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-2 space-y-4">
            <Link to="/" onClick={scrollToTop} className="flex items-center gap-2.5">
              ...
              <span className="text-lg font-bold tracking-tight text-foreground">ApplyWise</span>
            </Link>
            <p className="max-w-sm text-sm text-muted-foreground leading-relaxed">
              The AI-powered Career Operating System. Upload your knowledge base, get transparent ATS job matching, generate tailored applications, and master interviews.
            </p>
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="flex h-8 w-8 items-center justify-center rounded-lg border border-border bg-background text-muted-foreground transition-colors hover:border-primary hover:text-foreground"
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          ...
          <p className="flex items-center gap-1">
            Built with <Heart className="h-3.5 w-3.5 fill-red-500 text-red-500 inline" /> for job seekers everywhere
          </p>
        </div>
      </div>
    </footer>
