    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Sign in to your CareerOS account</p>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
          ...
          <button
            onClick={googleLogin}
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-medium shadow-sm transition-colors hover:bg-accent"
          >
